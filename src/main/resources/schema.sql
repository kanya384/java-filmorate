DROP TABLE IF EXISTS films_of_directors, events, review_likes, reviews, users_friendship, film_likes, "user", film_genre, genre, films, mpa_rating, directors;
...
CREATE TABLE IF NOT EXISTS films_of_directors (
    film_id BIGINT REFERENCES films(id) ON DELETE CASCADE,
